...
def make_template(line):
    ...
    # KEY : VALUE
    #
    # Delaem eto posle bazovyh specialnyh znachenij.
    # ------------------------------------------------------
    ...
    if kv_match:
        ...
        # Ne prevraschaem pustoe znachenie v VALUE
        if right.strip():
            ...
            try:
                ...
                with open(
                    ...
                    for line_number, line in enumerate(
                        ...
                        # Sohranjaem tolko neskolko primerov
                        if len(
                            item["examples"]
                        ) < 5:
                        ...
                        # Sohranjaem values
                        # Ogranichivaem chtoby summary ne stal gigantskim
                        if (
                            values
                            and len(
                                item["values"]
                        ...
                        # EVENT SEQUENCE
                        #
                        # Kazhdaja stroka = odin JSON object
                        #
                        # Eto JSONL, a ne bolshoj JSON.
                        # Ego mozhno chitat postrochno.
                        # ==================================
